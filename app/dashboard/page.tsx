...
export default function Dashboard() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      setIsAccessUnlocked(Boolean(userData.isUnlocked));
      ...
      <section className="dashboard-shell">
        <div className="dashboard-shell-header">
          <div className="space-y-3">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-semibold text-[var(--foreground-strong)]">
          ...
          <div className="dashboard-user-card">
            ...
            <div className="dashboard-user-chip-row">
              ...
              >
                {isAccessUnlocked ? "Subscriptions Aktif" : "Subscriptions Nonaktif"}
              </span>
            </div>
          </div>
        </div>
