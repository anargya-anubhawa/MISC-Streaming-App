  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-4">
        ...
        {video.description && (
          <div className="bg-[var(--surface)] rounded-lg p-4 text-sm text-[var(--foreground)] whitespace-pre-line">
            {video.description}
          </div>
        )}
      </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          <textarea
            ...
            className="w-full bg-[var(--surface)] p-3 rounded"
      ...
      <div className="space-y-4">
        {comments.map((comment) => (
          <div key={comment.id} className="flex gap-3">
            ...
            <div className="bg-[var(--surface)] px-3 py-2 rounded-lg w-full">
      ...
      {!fullscreen && (
        <div>
          <h2 className="text-lg text-[var(--accent-strong)]">Next Video</h2>
